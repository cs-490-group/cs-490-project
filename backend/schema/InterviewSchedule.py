...
class WritingPracticeSession(BaseModel):
    """Schema for a timed writing practice session"""
    uuid: str
    user_uuid: str
    question_uuid: str
    
    # Timing
    time_limit_seconds: int = Field(default=300, description="5 minutes default")
    ...
    # Analysis
    clarity_score: Optional[float] = Field(None, description="0-100")
    structure_score: Optional[float] = Field(None, description="STAR framework adherence")
    conciseness_score: Optional[float] = Field(None, description="0-100")
    professionalism_score: Optional[float] = Field(None, description="0-100")
    overall_score: Optional[float] = Field(None, description="Average of above")
...
class WritingAnalysisResult(BaseModel):
    """Result of analyzing a written response"""
    clarity_score: float
